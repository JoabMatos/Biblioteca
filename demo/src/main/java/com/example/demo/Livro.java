...
public class Livro {
    ...
    public Livro(long id, String titulo, String isbn, Integer numeroPaginas, LocalDate dataCompra, BigDecimal valorCompra, Status status, Conservacao conservacao, Autor autor, Editora editora) {
        this.id = id;
        this.titulo = titulo;
        this.isbn = isbn;
